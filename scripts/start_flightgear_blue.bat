@echo off
REM ============================================================
REM  FlightGear - Blue F-16 (ego agent)
REM  UDP port 5550, native-fdm receiver
...
echo [Blue] Starting FlightGear F-16 on UDP port 5550...
...
"%FG_EXE%" ^
  ...
  --prop:/sim/model/livery/file=Aircraft/f16/Models/Liveries/Block50/00-0220.xml ^
