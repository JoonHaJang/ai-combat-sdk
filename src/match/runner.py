                ...
                if _csv_writer is not None:
                    try:
                        row = {
                            ...
                            "ego_altitude": obs_i.get("ego_altitude", ""),
                            "ego_vc": obs_i.get("ego_vc", ""),
                            "ego_vx": obs_i.get("ego_vx", ""),
                            "ego_vy": obs_i.get("ego_vy", ""),
                            "ego_vz": obs_i.get("ego_vz", ""),
                            "roll_deg": obs_i.get("roll_deg", ""),
                            "pitch_deg": obs_i.get("pitch_deg", ""),
                            "specific_energy": obs_i.get("specific_energy", ""),
                            "ps": obs_i.get("ps", ""),
                            "distance": obs_i.get("distance", ""),
                            ...
                            "alt_gap": obs_i.get("alt_gap", ""),
                            "closure_rate": obs_i.get("closure_rate", ""),
                            "turn_rate": obs_i.get("turn_rate", ""),
                            ...
                            "energy_diff": obs_i.get("energy_diff", ""),
