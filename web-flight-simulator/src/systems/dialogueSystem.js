...
export class DialogueSystem {
	constructor() {
		...
		this.dialogues = [
			"Welcome, Pilot. I will be your flight instructor today.",
			"You are currently piloting the F-16 Fighting Falcon, an advanced multirole fighter.",
			...
			"Good luck out there, Pilot. Commander, out."
		];
		this.currentIndex = 0;
		this.isActive = false;
		this.isPaused = false;
